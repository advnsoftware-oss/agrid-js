...
describe('HistoryAutocapture', () => {
    ...
    beforeEach(() => {
        ...
        historyAutocapture = new HistoryAutocapture(agrid)
    ...
    describe('Initialization and Configuration', () => {
        it('should initialize correctly', () => {
            ...
            expect((window.history.pushState as any).__agrid_wrapped__).toBe(true)
            expect((window.history.replaceState as any).__agrid_wrapped__).toBe(true)
        })

        it('should NOT be enabled with true option for backwards compatibility', () => {
            agrid.config.capture_pageview = true
            const historyAutocaptureEnabled = new HistoryAutocapture(agrid)
        ...
        it('should be disabled with false option', () => {
            ...
            const historyAutocaptureDisabled = new HistoryAutocapture(agrid)
            expect(historyAutocaptureDisabled.isEnabled).toBe(false)
        })

        it('should be enabled with history_change option', () => {
            agrid.config.capture_pageview = 'history_change'
            const historyAutocaptureEnabled = new HistoryAutocapture(agrid)
        ...
        it('should not setup event listeners if feature is disabled', () => {
            ...
            expect((window.history.pushState as any).__agrid_wrapped__).toBeUndefined()
            expect((window.history.replaceState as any).__agrid_wrapped__).toBeUndefined()
        })
    ...
    describe('Cleanup', () => {
        it('should properly clean up event listeners when stopped', () => {
            ...
            const newHistoryAutocapture = new HistoryAutocapture(agrid)
