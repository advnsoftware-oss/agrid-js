...
import { AgridConfig, SessionIdChangedCallback } from './types'
...
export class SessionIdManager {
    ...
    private _config: Partial<AgridConfig>
    private _persistence: AgridPersistence
    ...
    constructor(instance: Agrid, sessionIdGenerator?: () => string, windowIdGenerator?: () => string) {
        if (!instance.persistence) {
            throw new Error('SessionIdManager requires a AgridPersistence instance')
        }
